...
4. **已在持仓/云端关注**的票 → **每周一自动**深度分析，无需 Issue
5. **新票第一次** → 收藏后在新页面点一次绿色 **Submit** 入队，约 5–10 分钟生成；之后也每周自动
...
| 常看的票 | **⭐ 收藏** → **我的关注** |
| 持仓 / 云端关注 | **每周一自动**深度分析 |
| **新票第一次** | 收藏 → GitHub **Submit 一次** → 等 5–10 分钟 |
| **立刻更新全部** | 选股页 **🔄 立即更新全部深度分析** → GitHub **Run workflow**（run_uzi=true）→ 约 30–60 分钟 |
