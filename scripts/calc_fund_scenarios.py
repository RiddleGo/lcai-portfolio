#!/usr/bin/env python3
"""基金赎回方案对比 · 8月凑钱 & 9-12月缺口（个人还款规划辅助）"""

FUNDS = [
    ("天弘创业板指数增强 C", 500.58, -19.42),
    ("国金量化多因子股票 C", 5115.06, -184.94),
    ("易方达证券保险 ETF 联接 C", 25893.55, -152.75),
    ("富国医药创新股票 C", 31843.10, -2629.20),
]

AUG_NEED = 259_791
JD_AUG = 106_951
SALARY_JUL_AUG = 40_000
PINGAN_TOTAL = 43600 * 8.74 * 0.92
PINGAN_SHARES = 43_600
...
def main():
    ...
    scenarios = {
        "A_8月4只全赎": aug_plan(total_fund),
        "B_8月留富国赎3只": aug_plan(total_fund - fuguo),
